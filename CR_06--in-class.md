...
7.4 ~S v (P -> T), (S & P) :|-: T
7.5 ~P, (R v ~P) <-> (P v Q) :|-: Q
7.6  R, ~(R & S) v (Q -> W), Q & S :|-: W
7.7 N & ~G, (J -> T) <-> K, (K v G) & J :|-: ~G & T
~~~

For 7.8, list the premise as you normally do. On line 2, hit tab and then put the assumption. Hit tab again and put `:AS`. 
