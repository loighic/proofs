...
This proof (in 11.9) requires two subproofs. Assume P first (for &rarr;<span style="font-family:serif;">I</span>) and then assume &not;Q (for &not;E). Also, take a look at section 14.10 in the textbook (&lsquo;Even more examples&rsquo;). A sub-proof inside a sub-proof looks like the fourth example in that section.
